...
// Oct-Sep monthly weight distribution per category (must each sum to 1.0)
const MONTHLY_PATTERNS: Record<string, number[]> = {
  Dining: [0.09, 0.09, 0.1, 0.07, 0.07, 0.08, 0.08, 0.09, 0.09, 0.08, 0.08, 0.08],
  Entertainment: [0.09, 0.09, 0.1, 0.07, 0.07, 0.07, 0.08, 0.08, 0.09, 0.09, 0.09, 0.08],
  Retail: [0.09, 0.1, 0.12, 0.06, 0.07, 0.07, 0.08, 0.08, 0.08, 0.08, 0.09, 0.08],
  Groceries: [0.09, 0.08, 0.08, 0.08, 0.08, 0.08, 0.08, 0.09, 0.08, 0.09, 0.08, 0.09],
  Travel: [0.08, 0.07, 0.06, 0.06, 0.07, 0.08, 0.09, 0.1, 0.1, 0.11, 0.1, 0.08],
  Transport: [0.08, 0.08, 0.08, 0.08, 0.08, 0.09, 0.08, 0.09, 0.08, 0.09, 0.08, 0.09],
  Healthcare: [0.08, 0.08, 0.08, 0.09, 0.08, 0.09, 0.08, 0.08, 0.08, 0.08, 0.09, 0.09],
  Education: [0.08, 0.09, 0.06, 0.1, 0.09, 0.09, 0.08, 0.07, 0.07, 0.07, 0.1, 0.1],
  Utilities: [0.08, 0.08, 0.08, 0.09, 0.08, 0.08, 0.08, 0.08, 0.09, 0.09, 0.08, 0.09],
}
...
export const MERCHANT_DATA: Record<string, CustomerMerchantData> = {
  // ── Riyaad van Damme — dining & entertainment heavy ─────────────────
  '100234567': {
    otherSpend: 157300,
    merchants: [
      m('nan', "Nando's", 'NA', 'Dining', '#10b981', 24800, 32, +8.4, '2026-09-14'),
      m('ste', 'Ster-Kinekor', 'SK', 'Entertainment', '#ec4899', 18600, 24, -2.1, '2026-09-10'),
      m('vid', 'Vida e Caffè', 'VC', 'Dining', '#10b981', 16200, 48, +12.6, '2026-09-18'),
      m('zar', 'Zara', 'ZA', 'Retail', '#f59e0b', 14800, 8, +5.2, '2026-08-28'),
      m('ube', 'Uber', 'UB', 'Transport', '#3b82f6', 13400, 86, +3.8, '2026-09-19'),
      m('spu', 'Spur', 'SP', 'Dining', '#10b981', 12900, 14, -4.2, '2026-09-08'),
      m('cli', 'Clicks', 'CL', 'Healthcare', '#f97316', 11200, 18, +1.2, '2026-09-15'),
      m('net', 'Netflix', 'NF', 'Entertainment', '#ec4899', 10800, 12, 0.0, '2026-09-01'),
      m('she', 'Shell', 'SH', 'Transport', '#3b82f6', 9800, 24, +2.4, '2026-09-17'),
      m('mrp', 'Mr Price', 'MP', 'Retail', '#f59e0b', 8600, 12, -1.8, '2026-09-03'),
      m('ocb', 'Ocean Basket', 'OB', 'Dining', '#10b981', 7200, 8, +6.4, '2026-08-30'),
      m('gam', 'Game', 'GM', 'Retail', '#f59e0b', 6800, 6, +9.2, '2026-08-22'),
    ],
  },
  ...
  '100567890': {
    otherSpend: 182200,
    merchants: [
      m('chk', 'Checkers', 'CH', 'Groceries', '#7c3aed', 68400, 104, +3.2, '2026-09-19'),
      m('woo', 'Woolworths Food', 'WF', 'Groceries', '#7c3aed', 52800, 78, +2.4, '2026-09-17'),
      m('cur', 'Curro Schools', 'CS', 'Education', '#6366f1', 48000, 24, +8.0, '2026-09-01'),
      m('pnp', 'Pick n Pay', 'PP', 'Groceries', '#7c3aed', 36400, 52, +1.6, '2026-09-15'),
      m('dis', 'Dis-Chem', 'DC', 'Healthcare', '#f97316', 28600, 36, +4.8, '2026-09-12'),
      m('esk', 'Eskom', 'ES', 'Utilities', '#ef4444', 24000, 12, +0.8, '2026-09-01'),
      m('vod', 'Vodacom', 'VO', 'Utilities', '#ef4444', 18000, 12, 0.0, '2026-09-01'),
      m('bpf', 'BP', 'BP', 'Transport', '#3b82f6', 16800, 36, +1.2, '2026-09-18'),
      m('cl2', 'Clicks', 'CL', 'Healthcare', '#f97316', 14200, 22, +2.8, '2026-09-14'),
      m('spa', 'Spar', 'SA', 'Groceries', '#7c3aed', 12400, 24, -1.2, '2026-09-11'),
      m('net2', 'Netcare', 'NC', 'Healthcare', '#f97316', 11200, 6, +6.4, '2026-08-28'),
      m('mak', 'Makro', 'MK', 'Retail', '#f59e0b', 10800, 8, +3.6, '2026-08-20'),
    ],
  },
  ...
  '100891234': {
    otherSpend: 232000,
    merchants: [
      m('fly', 'FlySafair', 'FS', 'Travel', '#06b6d4', 98400, 18, +22.4, '2026-09-16'),
      m('emi', 'Emirates', 'EM', 'Travel', '#06b6d4', 86200, 6, +12.8, '2026-09-04'),
      m('sun', 'Sun International', 'SI', 'Travel', '#06b6d4', 74800, 8, +18.6, '2026-09-10'),
      m('san', 'Sandton City', 'SC', 'Retail', '#f59e0b', 68400, 24, +8.4, '2026-09-18'),
      m('mar', 'Marble Restaurant', 'MR', 'Dining', '#10b981', 52800, 22, +14.2, '2026-09-19'),
      m('sax', 'The Saxon Hotel', 'TS', 'Travel', '#06b6d4', 48600, 4, +6.8, '2026-08-22'),
      m('mbs', 'Mercedes-Benz FS', 'MB', 'Transport', '#3b82f6', 42000, 12, +2.4, '2026-09-01'),
      m('hyd', 'Hyde Park Corner', 'HP', 'Retail', '#f59e0b', 38200, 18, +10.8, '2026-09-15'),
      m('wlw', 'Woolworths', 'WW', 'Retail', '#f59e0b', 34800, 26, +5.6, '2026-09-17'),
      m('spi', 'Spier Wine Farm', 'SW', 'Dining', '#10b981', 28400, 6, +28.4, '2026-08-30'),
      m('sh2', 'Shell', 'SH', 'Transport', '#3b82f6', 24600, 48, +3.2, '2026-09-19'),
      m('dst', 'DSTV Premium', 'DT', 'Entertainment', '#ec4899', 18000, 12, 0.0, '2026-09-01'),
    ],
  },
